  ...
  <div class="login-wrap">
    <div class="login-html">
      <div class="login-form">
        <form class="sign-up-htm" @submit="reset">
          <div class="group">
            <label for="email" class="label">Email Address</label>
            <input id="email" type="text" class="input" v-model="email" disabled>
            <div class="invalid-feedback" v-if="errors.email">{{errors.email[0]}}</div>
          </div>
          <div class="group">
            <label for="code" class="label">Verification code</label>
            <input id="code" type="text" class="input" v-model="verification_code">
          ...
          <div class="group">
            <input type="submit" class="button" value="Send code to email">
          </div>
          <div class="hr"></div>
          <div class="foot-lnk">
...
export default {
  ...
  methods: {
    async reset(event) {
      ...
      this.errors = {main: ''}
      axios.post('http://127.0.0.1:8000/api/auth/change-password', {
        'email': this.email,
...
.login-html .sign-in:checked + .sign-up{
  transform:rotate(0);
}
